...
data Post_sale_info = Post_sale_info
        ...
        , post_sale_info_invoice_status :: Xsd.XsdString
...
instance SchemaType Post_sale_info where
    ...
    schemaTypeToXML s x@Post_sale_info{} =
        toXMLElement s []
            ...
            , elementToXMLInvoice_status $ post_sale_info_invoice_status x
...
data Financial_transaction = Financial_transaction
        ...
        , financial_transaction_tax :: Xsd.Decimal
        , financial_transaction_tax_rate :: Xsd.Decimal
...
instance SchemaType Financial_transaction where
    ...
    schemaTypeToXML s x@Financial_transaction{} =
        toXMLElement s []
            ...
            , elementToXMLTax $ financial_transaction_tax x
            , elementToXMLTax_rate $ financial_transaction_tax_rate x
